	...
	var CKobject = {
		...
		embedSWF: function(C, D, N, W, H, V, P) {
			...
			var u = 'undefined',
                ...
                t = '<a href="' + r + '" target="_blank">Please click here to download and install the latest Flash Plug-in</a>',
				error = {
					w: 'Your web page does not conform to the W3C standard and can not display the player',
					f: 'You did not install the flash plug-in to play video，' + t,
					v: 'Your Flash plug-in version is too low to play video，' + t
				},
